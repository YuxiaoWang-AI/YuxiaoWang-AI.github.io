...
我目前是华南理工大学未来技术学院的博士研究生，师从刘琦教授，在多模态计算与交互（MCI）实验室从事研究工作。我的研究方向聚焦于多模态学习与人工智能，具体包括人-物交互检测、视觉语言模型（VLM）及人群计数等。我拥有10年编程经验，具备扎实的工程开发能力，能够熟练运用 PyTorch 等深度学习框架，并掌握 MongoDB、S3 等数据存储技术。在学术方面，我已公开发表论文10余篇，成果发表于 IEEE TCSVT、TNNLS、Neural Networks 等 SCI 一区 Top 期刊，以及 ICCV、AAAI 等 CCF A 类顶级会议。
在校期间，我曾多次荣获国家奖学金、华南理工大学校长奖学金等荣誉。此外，我积极参与各类学科竞赛，曾获河北省蓝桥杯程序设计大赛一等奖、Mathorcup 高校数学建模挑战赛大数据竞赛研究生组全国一等奖、中国高校大数据挑战赛研究生组全国一等奖等奖项。
